...
> Универсальный лаунчер для управления Telegram-ботом с поддержкой обработки текста (LLM) и генерации изображений (Stable Diffusion)
...
- 🚀 **Графический интерфейс** - Современный UI на CustomTkinter
- 🤖 **Управление ботом** - Запуск и мониторинг Telegram бота
- 📝 **Обработка текста** - Интеграция с Ollama для переработки контента
- 🎨 **Генерация изображений** - Stable Diffusion с ADetailer для создания визуального контента
- 📊 **Мониторинг** - Отслеживание состояния сервисов и системных ресурсов
...
2. Создайте тему (например, "Новости")
3. Добавьте каналы в тему (формат: `@username` или `https://t.me/username`)
4. Используйте кнопки "Открыть" и "Удалить" для управления
...
git clone https://github.com/F0RLE/telegram-bot-launcher.git
cd telegram-bot-launcher
...
1. Проверьте [Issues](https://github.com/F0RLE/telegram-bot-launcher/issues)
...
**Разработано с ❤️ для автоматизации работы с Telegram**
